...
body{
    ...
    background-image:url('https://img.freepik.com/free-vector/neon-lights-technology-geometric-background_52683-13534.jpg?size=626&ext=jpg');
    background-size:cover;
...
<form   method="post" action="./changepassword1.php" onsubmit="return validateForm()" name="myForm" >
